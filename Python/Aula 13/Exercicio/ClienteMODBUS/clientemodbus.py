    ...
    def atendimento(self):
        ...
        try:
            ...
            while atendimento:
                ...
                if sel == '1':
                    tipo = input ("""Qual tipo de dado deseja ler? (1- Holding Register |2- Coil |3- Input Register |4- Discrete Input| 5 - Float | 6- Múltiplos bits) :""") #pega o tipo de dado a ler
                    ...
                    tipo = input ("""Qual tipo de dado deseja escrever? (1- Holding Register) |2- Coil | 3- Float | 4 - Múltiplos Bits) :""") #pega tipo de dado a escrever
